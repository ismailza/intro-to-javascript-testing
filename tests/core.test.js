...
describe('validateUserInput', () => {
  it('should return success if given valid input', () => {
    expect(validateUserInput('ismail', 42)).toMatch(/success/i);
  });
  ...
  it('should return an error if username is longer than 30 characters', () => {
    expect(validateUserInput('A'.repeat(31), 42)).toMatch(/invalid/i);
  });
